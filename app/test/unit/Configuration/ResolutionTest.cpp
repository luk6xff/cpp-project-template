...
TEST(ResolutionTests, SettingToString) {
    ...
    std::string str960x1280 = Resolution::resolutionToStr(Resolution::Setting::h960w1280);
...
TEST(ResolutionTests, GetIntFromResolution) {
    ...
    auto res960x1280 = Resolution::getIntFromResolution(Resolution::Setting::h960w1280);
