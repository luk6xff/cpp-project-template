...
Animation::Animation(const std::vector<sf::Texture>& textures, bool isLooping) : m_isLooping(isLooping)
{
...
Animation::Animation(const sf::Texture& texture, bool isLooping) : m_isLooping(isLooping)
{
    sf::Sprite temp;
    temp.setTexture(texture);
    m_frames.push_back(std::move(temp));
