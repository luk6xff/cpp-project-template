...
void Animation::toggleInvisibility() {
  sf::Color newColor =
      m_invisible ? sf::Color::White : sf::Color{255, 255, 255, 0};
...
bool Animation::isInvisible() const { return m_invisible; }
...
void Animation::setMsBetweenFrames(int ms) { m_msBetweenFrames = ms; }
...
sf::Vector2f Animation::getScale() const { return m_frames.front().getScale(); }
