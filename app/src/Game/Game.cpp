...
Game::Game(
    ...
    m_timePerFrame(sf::seconds(1.f / 60.f)), m_delta(m_timePerFrame.asSeconds()), m_highScores({0, 0, 0}),
    m_lifeScale(0.07f), m_score(0), m_maxPlayerHealth(5), m_playerSpeed(420.f), m_enemyCarSpeed(210.f),
    m_enemyTruckSpeed(170.f), m_playerBulletSpeed(600.f), m_enemyBulletSpeed(300.f), m_backgroundSpeed(1200.f),
    m_enemyChanceNotToShoot(6.5f), m_shoot(false), m_moveUp(false), m_moveDown(false), m_moveLeft(false),
    m_moveRight(false)
{
    ...
    m_window.create(sf::VideoMode(m_screenWidth, m_screenHeight), "Volvo Cars Shooter", sf::Style::Close);
