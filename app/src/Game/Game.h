...
public:
   ...
   * the game.
   */
  Game(const std::filesystem::path &execDirPath,
       Resolution::Setting resolutionSetting, Difficulty::Level gameDifficulty);
...
private:
  ...
  void loadTextures();
  void loadCarTextures(std::vector<sf::Texture> &textures,
